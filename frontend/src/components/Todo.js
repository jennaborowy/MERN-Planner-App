...
function Todo() { 
    ...
    // make a calendar button to go to calendar view; need a useState
    ...
    // open calendar view or go back to Todo List
    const toggleCalendar = () => {
        viewCalendar ? setViewCalendar(false) : setViewCalendar(true);
    }
